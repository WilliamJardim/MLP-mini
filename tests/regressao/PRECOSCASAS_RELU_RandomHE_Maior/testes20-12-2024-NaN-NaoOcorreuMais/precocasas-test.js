...
const config = {
    layers: [
        ...
        { type: LayerType.Hidden, inputs: 11, units: 5, functions: Array(5).fill('ReLU') }, // 5 neurônios
        { type: LayerType.Final,  inputs: 5,  units: 1, functions: ['Linear'] } // 1 saída contínua
    ],
...
//Hyperparametros
const taxa_aprendizado = 0.0001;

//Epocas
const numero_epocas = 10000;
...
console.log('Total dos erros ao quadrado DADOS DE TESTE APOS TREINAMENTO: ', erroTotalTeste )
console.log('Média dos erros ao quadrado DADOS DE TESTE APOS TREINAMENTO: ', erroTotalTeste/quantidadeTestes )
